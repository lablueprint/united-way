...
//                     `http://192.168.1.31:4000/activities/filtered`,
...
//     const handleNext = () => {
//         if (currentQuestionIndex < polls[currentPollIndex].content.length - 1) {
//             setCurrentQuestionIndex((prev) => prev + 1);
//         } else if (currentPollIndex < polls.length - 1) {
...
//             setCurrentPollIndex((prev) => prev - 1);
//             setCurrentQuestionIndex(polls[currentPollIndex - 1].content.length - 1);
//         }
//     };
...
//     //         {polls.length > 0 ? (
//     //             <View key={polls[currentPollIndex]._id} style={styles.pollCard}>
//     //                 {/* Display only one question at a time */}
//     //                 <Text style={styles.questionText}>
//     //                     {polls[currentPollIndex].content[currentQuestionIndex].question}
//     //                 </Text>

//     //                 {polls[currentPollIndex].content[currentQuestionIndex].options.map((option) => (
//     //                     <View key={option.id} style={styles.optionContainer}>
//     //                         <Text style={styles.optionText}>{option.text} ({option.count} votes)</Text>
//     //                         <Button title={option.text} onPress={() => handleVote(polls[currentPollIndex]._id, option.id)} />
//     //                     </View>
//     //                 ))}

//     //                 {/* Navigation Buttons */}
//     //                 <View style={styles.navButtons}>
//     //                     <Button title="Previous" onPress={handlePrevious} disabled={currentPollIndex === 0 && currentQuestionIndex === 0} />
//     //                     <Button title="Next" onPress={handleNext} disabled={currentPollIndex === polls.length - 1 && currentQuestionIndex === polls[currentPollIndex].content.length - 1} />
//     //                 </View>
...
//     //                             styles.progressBar,
//     //                             {
//     //                                 width: `${((currentQuestionIndex + 1) / polls[currentPollIndex].content.length) * 100}%`,
//     //                             },
//     //                         ]}
//     //                     />
//     //                 </View>
...
//             {/* Show message if no active polls */}
//             {polls.filter((poll) => {
//                 const now = new Date();
//                 return new Date(poll.timeStart) <= now && now <= new Date(poll.timeEnd);
