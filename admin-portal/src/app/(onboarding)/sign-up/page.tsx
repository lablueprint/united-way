...
export default function SignUp() {
  ...
  const getOrgByEmail = async () => {
    try {
      const response: AxiosResponse = await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/api/orgs/filtered`,
        { email }
      );
  ...
  const sendOTP = async () => {
    try {
      const response: AxiosResponse = await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/api/twofactor/sendOTP`,
        { email }
      );
      if (response.data) {
  ...
  const verifyOTP = async () => {
    try {
      const response: AxiosResponse = await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/api/twofactor/verifyCode`,
  ...
  const addOrgToDatabase = async () => {
    ...
    try {
      const response: AxiosResponse = await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/api/orgs/createOrg`,
